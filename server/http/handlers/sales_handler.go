...
func (handler SalesHandler) Browse(ctx *fiber.Ctx) (err error) {
	// Get Query Param
	...
	// Database Processing
	uc := usecase.NewSalesUseCase(handler.UcContract)
...
func (handler SalesHandler) ReadByID(ctx *fiber.Ctx) (err error) {
	// Get Param
	ID := ctx.Params("id")
...
func (handler SalesHandler) Add(ctx *fiber.Ctx) (err error) {

	// Parse & Checking input
	input := new(request.SalesRequest)
...
func (handler SalesHandler) Edit(ctx *fiber.Ctx) (err error) {
	// Get Param
	ID := ctx.Params("id")
...
func (handler SalesHandler) DeleteByID(ctx *fiber.Ctx) (err error) {
	// Get Param
	ID := ctx.Params("id")
