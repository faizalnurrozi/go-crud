...
func (handler SupplierHandler) Browse(ctx *fiber.Ctx) (err error) {
	// Get Query Param
	...
	// Database Processing
	uc := usecase.NewSupplierUseCase(handler.UcContract)
...
func (handler SupplierHandler) ReadByID(ctx *fiber.Ctx) (err error) {
	// Get Param
	ID := ctx.Params("id")
...
func (handler SupplierHandler) Add(ctx *fiber.Ctx) (err error) {

	// Parse & Checking input
	input := new(request.SupplierRequest)
...
func (handler SupplierHandler) Edit(ctx *fiber.Ctx) (err error) {
	// Get Param
	ID := ctx.Params("id")
...
func (handler SupplierHandler) DeleteByID(ctx *fiber.Ctx) (err error) {
	// Get Param
	ID := ctx.Params("id")
