...
func (handler CustomerHandler) Browse(ctx *fiber.Ctx) (err error) {
	// Get Query Param
	...
	// Database Processing
	uc := usecase.NewCustomerUseCase(handler.UcContract)
...
func (handler CustomerHandler) ReadByID(ctx *fiber.Ctx) (err error) {
	// Get Param
	ID := ctx.Params("id")
...
func (handler CustomerHandler) Add(ctx *fiber.Ctx) (err error) {
	...
	input := new(request.CustomerRequest)
...
func (handler CustomerHandler) DeleteByID(ctx *fiber.Ctx) (err error) {
	// Get Param
	ID := ctx.Params("id")
